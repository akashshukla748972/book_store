    ...
    <div className="card dark:bg-base-100  w-full md:w-96 shadow-xl hover:shadow-2xl p-2 hover:scale-105 duration-300 transition-all ease-in-out hover:z-30">
      ...
      <div className="card-body">
        ...
        <div className="card-actions justify-between my-2">
          <div className="border dark:border-gray-100 dark:text-gray-100 rounded-2xl py-[1px] px-4 hover:border-none hover:bg-pink-500 duration-300 transition-all ease-in-out">
            ${book.price}
          </div>
          <div className="border dark:border-gray-100 dark:text-gray-100 rounded-2xl py-[1px] px-4 hover:border-none hover:bg-pink-500 duration-300 transition-all ease-in-out">
            Buy Now
